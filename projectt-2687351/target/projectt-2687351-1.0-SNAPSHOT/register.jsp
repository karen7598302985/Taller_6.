    ...
    <main class="form-signin w-100 m-auto">
      <form action="" method="post">
        ...
        <div class="form-floating mb-3">
          <input type="text" class="form-control" id="id" name="Password" placeholder="Ingrese su contraseña" required pattern="^(?=.*\d)(?=.*[\u0021-\u002b\u003c-\u0040])(?=.*[A-Z])(?=.*[a-z])\S{8,16}$">
          <label for="text">Document number: </label>
        ...
        <div class="form-floating mb-3">
          <input type="email" class="form-control" id="email" name="Password" placeholder="Ingrese su contraseña" required pattern="^(?=.*\d)(?=.*[\u0021-\u002b\u003c-\u0040])(?=.*[A-Z])(?=.*[a-z])\S{8,16}$">
