...
public class TestUserRepositoryImpl {
    ...
    public static void main(String[] args) throws SQLException {
        co.edu.sena.project2687351.model.Repository.Repository<User> repository = (co.edu.sena.project2687351.model.Repository.Repository<User>) new co.edu.sena.project2687351.model.Repository.UserRepositorylmpl();
